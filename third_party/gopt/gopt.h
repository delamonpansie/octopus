...
struct gopt { int k; int f; const char *s; const char*const*l; const char *a; const char *h;};
#define gopt_start(...)  (const void*)( const struct gopt[]){ __VA_ARGS__, {0, 0, NULL, NULL, NULL, NULL}}
